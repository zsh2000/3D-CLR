...
class LSeg(BaseModel):
    ...
    def forward(self, x, labelset=''):
        ...
        image_features2 = copy.deepcopy(image_features)
        ...
        # image_features2 = image_features.view(240, 240, 512).permute(2,0,1).unsqueeze(0)

        image_features2 = self.scratch.output_conv(image_features2)

        out = self.scratch.output_conv(out)

        return image_features2, text_features, out
